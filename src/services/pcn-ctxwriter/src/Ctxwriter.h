...
class Ctxwriter : public CtxwriterBase {
 public:
  Ctxwriter(const std::string name, const CtxwriterJsonObject &conf);
  virtual ~Ctxwriter();
  ...
  /// </summary>
  CtxwriterActionEnum getAction() override;
  void setAction(const CtxwriterActionEnum &value) override;
